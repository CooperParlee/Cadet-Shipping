...
As otherwise mentioned, we used two different oils for the main engine: cylinder and system oil. To add more of this oil to the main engine, it is as simple as lining the respective tank with the lube oil transfer pump and transferring it to the respective sump for that oil.
