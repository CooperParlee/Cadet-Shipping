...
# Part 1: Emergency Rules and Safety Equipment (All Vessels) {.unnumbered}
...
![$CO_2$ protected zones for the ship](Pictures/part1/co2_zones.png)
...
![Image of Hyper Mist local control panel within the Engine Control Room.](Pictures/part1/hyper_mist.png)
...
![fixed $CO_2$ fire fighting system tanks within the $CO_2$ room on the upper deck](Pictures/part1/co2_tanks.png)

![$CO_2$ fire fighting system control panel within the $CO_2$ room](Pictures/part1/co2_control.png)
