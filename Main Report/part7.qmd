...
Water flow through the ship's refrigeration condensers was controlled by oriface plates and gate valves. The gate valves did not offer significant control over the water flow through the refrigeration system, but did allow for isolation of the cooling system at those points. The major regulator for pressure were the oriface plates. The designers of the system knew the design pressure of the central fresh water system and stepped it down to safe levels for the refrigeration condenser cooling system using intentionally-sized oriface plates.

4.	List and describe any maintenance performed on the refrigeration system while you were aboard.

There was very little maintenance performed on the ship's refrigeration system while I was onboard. While I was onboard, the chief engineer replaced the compressor oil for the inboard refrigerant compressor and added more refrigerant to the outboard compressor. He suggested that he would just wait for the telltale alarm that the potato box temperature was getting too high to add refrigerant. He said that the potato box was always the first system to start increasing in temperature because it was the last system at the end of the refrigerant header. From there, he would connect up his refrigerant bottle with gauges to the compressor suction and discharge and add addtional refrigerant per the manufacturer's guidelines.
