...
**Ship**: ARC INDEPENDENCE
**EQP**: 584.01 COLD WATER FOUNTAINS
**MFG**: (not provided)
**PART**: FILTER FOR D.W FOUNTAIN
**LOC**: ME STORE 06*06-03-03
**P/N**: 584.01.SKPM-SML-053-00 * WALL-8530004028
**PIN**: 12801
...
![Main engine system oil sampling point after the Moatti filters]()
...
![Main engine cylinder oil sampling point]()
...
![Diesel engine oil sampling point]()
...
![Alfa Laval S861 fuel oil purifier nameplate]()
![Alfa Laval S831 lube oil purifier nameplate]()
